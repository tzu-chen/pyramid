...
const BACKENDS: BackendDef[] = [
  ...
  },
  {
    ...
    args: ['--version'],
    category: 'language',
    used_for: ['Rust single-file execution (no-Cargo fallback)'],
    versionRegex: /rustc\s+([\d.]+)/i,
  },
  {
    key: 'cargo',
    name: 'Cargo',
    ...
    args: ['--version'],
    category: 'build_tool',
    used_for: ['Rust project scaffolding, build/run/test, and dependency management'],
    versionRegex: /cargo\s+([\d.]+)/i,
  },
  {
    key: 'rust-analyzer',
    name: 'rust-analyzer',
    ...
    args: ['--version'],
    category: 'lsp',
    used_for: ['Rust language server (diagnostics, hover, completion, outline)'],
    versionRegex: /rust-analyzer\s+([\w.+-]+)/i,
  },
  {
    key: 'cargo-clippy',
    name: 'Clippy',
    ...
    used_for: ['Rust linter (cargo clippy)'],
    versionRegex: /clippy\s+([\d.]+)/i,
  },
  {
    key: 'lldb-dap',
    name: 'lldb-dap',
    ...
    args: ['--version'],
    category: 'debugger',
    used_for: ['Rust debugger (DAP-backed Debug panel)'],
    stream: 'both',
    versionRegex: /lldb[^\d]*([\d.]+)/i,
  },
  {
    key: 'lean',
    name: 'Lean',
